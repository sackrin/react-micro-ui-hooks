...
function useMicroUIState(defaultState, path) {
  var prefix = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'MICROUI';
  ...
  var windowName = (0, _getMicroUIWindowName.default)('STATE', path, prefix);
  var windowStash = window[windowName] || (0, _getMicroUIWindowState.default)(state, windowName);
  windowStash.subscribe(function (value) {
    setState(value);
  });
