...
var MicroUIComponent = function MicroUIComponent(props) {
  ...
  var _props$microUi = props.microUi,
      ...
      name = _props$microUi.name,
      _props = _objectWithoutProperties(props, ["microUi"]); // We need to have a ref, this will be the component the micro UI's internal reactDomRender will render into
